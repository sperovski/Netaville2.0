...
import {Coffee, Gift, GraduationCap} from 'lucide-react-native';
...
import {StampQr} from '@/components/StampQr';
    ...
    <Screen scroll>
      ...
      <View style={styles.section}>
        <View style={styles.card}>
          ...
          {/* No add/remove here. Stamps are given at the counter, and a card
              that can stamp itself is not a loyalty card — the QR is how one
              gets added, and the staff side of it is what scans. */}
          <StampGrid filled={stamps} />
          <View style={styles.qrRule} />
          <StampQr />
        </View>
      </View>
